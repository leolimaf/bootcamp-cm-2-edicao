            ...
            <div className="card is-shady">
                ...
                <div className="content book" data-id="${product.id}">
                    <div className="book-meta">
                        <p className="is-size-4">{formatPrice(product.price)}</p>
                        <p className="is-size-9">ID: {product.id}</p>
                        <p className="is-size-6">Disponível em estoque: <span id="Quantidade${product.id}">{product.available_quantity}</span></p>
                        <h4 className="is-size-5 title">{product.title}</h4>
                    </div>
